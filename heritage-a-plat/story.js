    ...
    chapters: [
        {
            ...
            events: [
                {
                    id: 'intro_morning',
                    image: 'decor-maison.webp',
                    title: 'Un nouveau matin',
                    text: "Les premiers rayons du soleil filtrent à travers les rideaux. C'est un matin paisible. À tes côtés, {partenaire} dort encore. Tu contemples ce moment de calme avant que le tumulte de la journée ne commence. Entre tes ambitions professionnelles et ton besoin de sérénité, chaque journée ressemble à une danse délicate.",
                    choices: [
                        {
                            id: 'meditate',
                        ...
                        {
                            id: 'wake_partner',
                            text: "Réveiller {partenaire} en douceur.",
                ...
                },
                {
                    ...
                    text: "À la cuisine, les discussions tournent autour des projets de la semaine. {partenaire} évoque ses doutes sur l'avenir, tandis que ton téléphone ne cesse de vibrer avec des notifications du bureau. On te demande de venir plus tôt pour une réunion imprévue.",
                    choices: [
                        {
                            id: 'listen_partner',
                            relationships: { partner: 12 },
                            text: "Poser le téléphone et écouter vraiment.",
                            result: "Une connexion sincère avec {partenaire}. Le travail attendra quelques minutes, mais ton couple en sort renforcé.",
                        ...
                        {
                            id: 'hurry_work',
                            relationships: { partner: -8 },
                            text: "M'excuser et partir rapidement.",
                            result: "Tu es ponctuel et efficace, mais le regard déçu de {partenaire} reste gravé dans ton esprit.",
        ...
        },
        {
            ...
            events: [
                ...
                },
                {
                    ...
                    text: "La discussion avec {partenaire} est inévitable. Déménager à Dakar changerait tout pour vous deux. Elle a ses propres racines ici, son propre travail. L'atmosphère est électrique, chargée d'espoirs et de craintes partagées.",
                    choices: [
                        {
                            id: 'promise_luxury',
                ...
                {
                    id: 'the_charity_gala',
                    image: 'decor-gala.webp',
                    title: 'Le Gala de la Fondation',
                    text: "Mr. Mensah t'invite au gala annuel de la Fondation pour l'Éducation. C'est l'occasion idéale pour briller devant les investisseurs. Cependant, {partenaire} comptait sur toi pour assister à une réunion de quartier importante concernant un projet qui lui tient à cœur. Le temps presse, tu ne peux pas être aux deux endroits.",
                    choices: [
                        {
                            id: 'gala_networking',
                            text: "Prioriser le Gala et le réseau.",
                            result: "Tu échanges des cartes de visite avec les plus grands. Ton influence au bureau bondit, mais tu manques un moment crucial pour {partenaire}.",
                        ...
                        },
                        {
                            ...
                            text: "Soutenir {partenaire} et le projet local.",
                            result: "Ton geste touche profondément {partenaire}. Tu renforces tes liens communautaires, même si Mr. Mensah note ton absence.",
            ...
            events: [
                {
                    ...
                    choices: [
                        ...
                        },
                        {
                            ...
                            result: "Tu cherches le compromis. La famille est reconnaissante mais déçue, et {partenaire} apprécie ta prudence financière.",
                        ...
                        {
                            id: 'refuse_family',
                            relationships: { friend: -10, partner: 5 },
                ...
                },
                {
                    ...
                    text: "{partenaire} te confie son désir de reprendre ses études ou de lancer sa propre entreprise. Cela signifie que pendant un an, tu devras assumer [seul/seule] les charges du foyer et sans doute mettre tes propres ambitions en pause.",
                    choices: [
                        {
                        ...
                        },
                        {
                            ...
                            result: "Le dialogue est constructif. Le chemin sera plus long, mais vous avancez main dans la main avec {partenaire}.",
        ...
        },
        {
            ...
            events: [
                ...
                },
                {
                    ...
                    text: "Un projet de réhabilitation d'un parc local est en difficulté financière. Les habitants comptent sur des leaders comme toi pour investir ou mobiliser des fonds. Cet argent pourrait aussi servir à financer un voyage de repos dont vous avez désespérément besoin avec {partenaire}.",
                    choices: [
                        {
                            id: 'invest_park',
                        ...
                        {
                            id: 'choose_rest',
                            relationships: { partner: 7, friend: 8 },
                            text: "Privilégier notre voyage de repos.",
                            result: "Vous revenez transformés et pleins d'énergie. Votre couple avec {partenaire} rayonne, mais le parc reste en friche, rappelant une occasion manquée d'aider.",
        ...
        },
        {
            ...
            events: [
                ...
                },
                {
                    ...
                    text: "Les fissures du passé deviennent des gouffres. {partenaire} et toi ne parlez plus le même langage. Une dispute éclate sur la direction de votre vie commune, menaçant de tout briser.",
                    choices: [
                        {
                            id: 'intensive_therapy',
                            relationships: { partner: 10 },
                            text: "Proposer un dialogue profond et sincère à {partenaire}.",
                        ...
                        },
                        {
                            ...
                            relationships: { partner: -6 },
                            text: "Prendre de la distance quelques jours.",
                            result: "Le silence est lourd. Tu retrouves une forme de paix solitaire, mais l'avenir de ton couple avec {partenaire} est en suspens.",
        ...
        },
        {
            ...
            events: [
                ...
                },
                {
                    ...
                    text: "Le soir venu, tu partages un thé avec {partenaire}. Les non-dits se sont accumulés, mais l'envie de reconstruire est mutuelle. 'Nous avons survécu à la tempête', murmure-t-elle, 'mais comment allons-nous naviguer désormais ?' C'est le moment de définir les nouvelles règles de votre vie commune.",
                    choices: [
                        {
            ...
            events: [
                {
                    ...
                    choices: [
                        {
                            id: 'invest_in_youth',
                            relationships: { mentor: 10, friend: 4 },
                        ...
                        },
                        {
                            ...
                            relationships: { mentor: -6, manager: 7 },
                        ...
                        },
                        {
                            ...
                            relationships: { mentor: 6, manager: 4 },
                ...
                },
                {
                    ...
                    text: "En marchant avec {partenaire}, vous croisez une personne que vous aviez aidée il y a des années. Elle vous remercie chaleureusement : sans votre intervention, sa vie aurait pris un tout autre tournant. Cela vous amène à réfléchir : quelle est la trace la plus importante que vous souhaitez laisser ?",
                    choices: [
                        {
                            id: 'trace_of_love',
                            text: "Le souvenir d'une vie vécue dans l'amour.",
                            result: "{partenaire} te serre la main. Vous comprenez que vos relations sont votre plus beau chef-d'œuvre. L'équilibre est dans le cœur.",
                    ...
                    choices: [
                        {
                            ...
                            relationships: { partner: -7, manager: 8 },
                        ...
                        },
                        {
                            ...
                            result: "Tu choisis la liberté et l'intimité. Ta décision surprend le monde, mais le regard de gratitude de {partenaire} et ta paix intérieure confirment que tu as choisi ta vérité.",
 ...
 */
/**
 * Fait entrer en scène les personnages que la vie du joueur appelle.
 *
 * Le Dr Sow et Baba étaient déclarés `active: false` sans qu'aucun code ne
 * les active jamais : ils n'existaient donc pas. On les fait apparaître au
 * moment où ils ont un sens — le médecin quand le corps lâche, le mentor
 * quand le doute s'installe ou que le lien s'est nourri.
 *
 * @returns {string[]} les personnages qui viennent d'entrer en scène
 */
export function activerPersonnages() {
    const c = state.progress.characters;
    const stats = state.progress.stats;
    const nouveaux = [];

    // Le médecin apparaît quand la Santé décroche vraiment.
    if (c.doctor && c.doctor.active === false && stats.health <= 35) {
        c.doctor.active = true;
        nouveaux.push('doctor');
    }

    // Le mentor apparaît dans le doute — un équilibre qui vacille — ou dès
    // que le joueur a choisi de l'écouter.
    if (c.mentor && c.mentor.active === false
        && (state.progress.balance.score < 45 || c.mentor.relationship >= 88
            || state.progress.chapterIndex >= 5)) {
        c.mentor.active = true;
        nouveaux.push('mentor');
    }

    return nouveaux;
}

/** Point d'équilibre vers lequel un lien négligé revient. */
const NEUTRE = 50;

/** Part de l'écart au neutre qu'un lien perd à chaque chapitre. */
export const EROSION_DES_LIENS = 0.12;
...
export function appliquerUsure() {
    ...
    // Les liens s'étiolent aussi, mais vers l'indifférence et non vers la
    // haine : un proche négligé s'éloigne, il ne devient pas un ennemi.
    //
    // L'érosion est proportionnelle à l'écart au neutre, et non d'un nombre
    // fixe de points : un lien intense demande beaucoup d'entretien, un lien
    // ténu n'a presque rien à perdre. Une érosion fixe effaçait les
    // personnages secondaires, qui n'ont que deux ou trois scènes.
    Object.values(state.progress.characters).forEach(c => {
        if (typeof c.relationship !== 'number') return;
        const ecart = c.relationship - NEUTRE;
        c.relationship = Math.round(NEUTRE + ecart * (1 - EROSION_DES_LIENS));
    });
...
export function getReputationTags() {
    ...
    // Les liens tissés disent aussi qui l'on est.
    const c = state.progress.characters;
    if (c.partner && c.partner.relationship >= 80) tags.push('Aimant[/e]');
    if (c.mentor && c.mentor.relationship >= 90) tags.push('Disciple de Baba');
    if (c.manager && c.manager.relationship <= 20) tags.push('Insoumis[/e]');
    if (c.friend && c.friend.relationship >= 80) tags.push('Fidèle en amitié');
